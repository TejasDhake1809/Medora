      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <div className='mt-10'>
            {
              isEdit 
              ? <button className='border border-primary px-8 py-2 rounded-full banner-card-hover hover:text-white transition-all' onClick={updateUserProfileData}>Save Information</button> 
              : <button className='border border-primary px-8 py-2 rounded-full banner-card-hover hover:text-white transition-all' onClick={() => setIsEdit(true)}>Edit</button>
            }
          </div>
